...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $comment = $_POST['trip_comment'];
    $rating = $_POST['trip_rating'];
}

$stmt = $pdo->prepare("INSERT INTO review (title, rating, comment, post_date, trip_id VALUES (:title, :rating, :comment, :post_date, :trip_id)");
